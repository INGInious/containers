...
Container python3 for AI, Deep Learning and NLP (inginious/env-python3-ai)
-------------------------------------------------------------------------

A container with Python 3 as main language.
The container contains python packages for Artificial Intelligence, Deep Learning and Natural Language Processing:
